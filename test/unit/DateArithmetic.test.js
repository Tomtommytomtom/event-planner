...
test('should add days to a date', () => {
  const addDaysToDate = DateArithmetic.addDaysToDate

  expect(addDaysToDate('2020-01-01', 1)).toBe('2020-01-02')
  expect(addDaysToDate('2020-01-01', 5)).toBe('2020-01-06')
  expect(addDaysToDate('2020-01-07', 40)).toBe('2020-02-16')
})
